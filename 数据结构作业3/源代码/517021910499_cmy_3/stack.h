...
//************************
template <class T>
class seqstack2:public seqlist<T>
{
private:
    seqlist<T> alist;
public:
...
template <class T>
bool seqstack2<T>::isempty()const
{
    return alist.length()==0;
}

template <class T>
void seqstack2<T>::push(const T&x)
{
    alist.insert(alist.length(),x);
}

template <class T>
T seqstack2<T>::top()const
{
    return alist.visit(alist.length()-1);
}

template<class T>
T seqstack2<T>::pop()
{
    T tmp=alist.visit(alist.length()-1);
